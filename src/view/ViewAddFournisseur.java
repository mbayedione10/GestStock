 ...
 */
public class ViewAddFournisseur extends javax.swing.JFrame {

    /**
     * Creates new form ViewAddFournisseur
     */
    public ViewAddFournisseur() {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        boolean b = db.saveFournisseur(fourn);

        if(b){
            //pour afficher a l'ecran

            JOptionPane.showMessageDialog(this, "SUCCESS! Fournisseur " +nom+ " "+prenom+ " enregistré ");
            ...
            JOptionPane.showMessageDialog(this, "ERROR! Fournisseur  non enregistré");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAddFournisseur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAddFournisseur().setVisible(true);
            }
        });
    }
